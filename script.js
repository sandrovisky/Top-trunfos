var carta1 = {
  ...
  function  
    var radioAtributo = document.getElementsByName
    for (var i = 0; i < radioAtributo.length; i 
      if (radioAtributo[i] 
        return radioAtributo[i
      }
    }
  }
  ...
  function jogar 
    ...
    if (cartasDaMaquina.length == 5 || cartasDoJogador.length == 5 
      ...
      if (cartasDaMaquina.length == 5 
        htmlResultado = `<p class='resultado-final'> End of the game ! The winner was the machine by ${cartasDaMaquina.length} to ${cartasDoJogador.length}
        document.getElementById("btnReiniciar").innerHTML 
          "<button type='button' onclick='reiniciar()'>Restart</button>"
      }  
        htmlResultado = `<p class='resultado-final'>End of the game ! The winner was you by ${cartasDoJogador.length} to ${cartasDaMaquina.length}
        document.getElementById("btnReiniciar").innerHTML 
          "<button type='button' onclick='reiniciar()'>Restart</button>"
      }
    } else 
  ...
  function exibirCartaJogador() {
    ...
    divCartaJogador.innerHTML = 
        <div class="card">
          <img class="card-imagem" src="${cartaJogador.imagem}
          <div class="card-info">
